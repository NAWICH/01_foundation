...
def save_posts(posts):
    ...
    try:
        connection = create_connection()
        cursor = connection.cursor()
        cursor.execute("""INSERT INTO post(title, content, author_id, created_at, updated_at) VALUES(?,?,?,?,?)""",
                      (posts['title'], posts['content'], posts['author_id'], posts['created_at'], posts['updated_at']))
        connection.commit()
